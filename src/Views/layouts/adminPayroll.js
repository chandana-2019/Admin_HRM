...
const AdminPayroll = () => {
  ...
  // redirect on clicking upload payroll
  const uploadPay = () => {
    history.push("/addpay");
  };
    ...
    return (
      <div className="container-fluid emp_Container">
        <div className="row">
          ...
          {/*start row having  dowld ,upload  button */}
          <div className="row">
            <div className="mx-sm-3 mb-2 mr-2">
              <select
                id="searchOption"
                name="searchOption"
            ...
            <div className=" mx-sm-3 mb-2">
              <button
                className="btn white_color_btn mx-sm-3"
                data-toggle="modal"
                data-target="#myModal"
              >
                Download Excel
              ...
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  <div className="modal-header">
                    <h4 className="modal-title">Download payroll list?</h4>
                    <button
                      type="button"
                      className="close"
                      data-dismiss="modal"
                  ...
                  <div className="modal-body">
                    Are you sure you want to download the payroll of filtered
                    list of candidates?
                    <div className="custom-control custom-checkbox mt-2">
                      ...
                      />
                      <label
                        className="dwd custom-control-label"
                        htmlFor="check2"
                      >
          ...
          {/*end of row having  dowld. upload  button  */}
        </div>
        <hr></hr>
        <div className="row">
